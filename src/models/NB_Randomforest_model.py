...
def nu_svc(X_train_tfidf, X_test_tfidf, y_train, y_test):
    clf = NuSVC(nu=0.2, kernel='poly', degree=5)
...
def classifier_selector(classifier, X_train_tfidf, X_test_tfidf, y_train, y_test):
    ...
    elif classifier==3: return nu_svc(X_train_tfidf, X_test_tfidf, y_train, y_test)
